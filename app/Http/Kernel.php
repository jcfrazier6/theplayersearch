...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        'parental' => \App\Http\Middleware\RedirectIfNotParental::class,
        'parental.guest' => \App\Http\Middleware\RedirectIfParental::class,
        ...
        'coach' => \App\Http\Middleware\RedirectIfNotCoach::class,
        'coach.guest' => \App\Http\Middleware\RedirectIfCoach::class,
        'player' => \App\Http\Middleware\RedirectIfNotPlayer::class,
        'player.guest' => \App\Http\Middleware\RedirectIfPlayer::class,
